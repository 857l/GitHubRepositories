...
class SingInButtonSavedState : View.BaseSavedState {
    ...
    companion object CREATOR : Parcelable.Creator<SingInButtonSavedState> {
        override fun createFromParcel(parcel: Parcel): SingInButtonSavedState =
            SingInButtonSavedState(parcel)

        override fun newArray(size: Int): Array<SingInButtonSavedState?> =
            arrayOfNulls(size)
    }
}